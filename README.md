...
[![npm](https://img.shields.io/npm/v/@magnexis/pagesmark.svg)](https://www.npmjs.com/package/@magnexis/pagesmark)

Package version **1.00** (`1.0.0`). Default branch is **`main`** — never `master`.

**Docs:** [GitHub Pages](https://theworker02.github.io/pagesmark/) · **Source:** [`theworker02/pagesmark`](https://github.com/theworker02/pagesmark) · **Release 1.00:** [`v1.0.0`](https://github.com/theworker02/pagesmark/releases/tag/v1.0.0) · **npm:** [`@magnexis/pagesmark`](https://www.npmjs.com/package/@magnexis/pagesmark)
...
```bash
npm install -g @magnexis/pagesmark
pagesmark --help
```

Package page: https://www.npmjs.com/package/@magnexis/pagesmark
